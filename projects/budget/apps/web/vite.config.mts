...
const cacheDir = `${workspaceRelativeRoot}node_modules/.vite/projects/budget/apps/web`;
const clientOutDir = `${workspaceRelativeRoot}dist/projects/budget/apps/web/client`;
...
export default defineConfig(async ({ command }) => {
  ...
  const apiPort = getProductApiPort('budget');
  const webPort = getProductWebPort('budget');
